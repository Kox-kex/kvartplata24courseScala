...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  return $as_sci_Map(namedExpressions.map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, namedExpressions$1) {
    return (function(x$2) {
      ...
      var jsx$1 = x.$$und1$f;
      $m_Lcalculator_Signal$();
      var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, x$1, namedExpressions$1$1) {
        return (function() {
          return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($m_Lcalculator_Calculator$().getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr($as_T(x$1.$$und1$f), namedExpressions$1$1), namedExpressions$1$1)
        })
      })($this, x, namedExpressions$1));
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(x3.name$2, references);
      continue _eval
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, delta$1, b$1, a$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var array$1 = [(((-jsx$4) + jsx$3) / (2 * jsx$2)), (((-jsx$1) - $uD($g.Math.sqrt(x$1))) / (2 * $uD(a$1.apply__O())))];
